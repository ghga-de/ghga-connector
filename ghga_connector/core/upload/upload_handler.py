...
from ghga_connector.core.upload.api_calls import Uploader, UploaderBase, UploadStatus
...
async def run_upload(  # pylint: disable=too-many-arguments
    ...
    try:
        ...
        raise exceptions.FinalizeUploadError(cause="Confirming the upload failed.")
