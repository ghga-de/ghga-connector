...
async def set_runtime_test_config():
    ...
    async with (
        set_context_var(upload_api_url_var, UPLOAD_API_URL),
        set_context_var(download_api_url_var, DOWNLOAD_API_URL),
        set_context_var(work_package_api_url_var, WORK_PACKAGE_API_URL),
